    ...
    <div>
      ...
      <div className="lg:my-9 md:my-6 my-4 w-full flex justify-center">
        <div className="flex justify-between items-center xl:w-[84%] w-[90%]">
          <div className="flex items-center md:gap-8 sm:gap-7 gap-6">
          ...
          <div className="lg:flex hidden gap-6 min-[1400px]:w-[38%] w-auto">
            <a
              href="#"
          ...
          <div className="min-[1326px]:w-[53%] min-[1400px]:w-[60%] lg:w-[43.5%] w-auto flex justify-between items-center">
            <div
              className={`flex ${
                showInput
                  ? "bg-[#F0F0F0] py-3 px-4 gap-3 rounded-[62px] w-[74%]"
                  : ""
              } xl:w-[84%] lg:w-[80%]`}
            >
              <svg
